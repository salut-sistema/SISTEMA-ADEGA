...
const ENUMS = {
  ...
  FRASES_CATEGORIAS: {
    ...
    doce:  "Escolhido para oferecer a melhor experiência.",
    bebida:" Qualidade, cuidado e atenção em cada detalhe.",
    complemento: " Produzido com dedicação para surpreender você.",
